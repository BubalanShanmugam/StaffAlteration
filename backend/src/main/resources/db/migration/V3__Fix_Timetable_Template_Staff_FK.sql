-- Drop and recreate the timetable_template table with correct foreign key

-- First drop the table if it exists
DROP TABLE IF EXISTS timetable_template CASCADE;

-- Recreate with correct schema - staff_id should be BIGINT referencing staff(id)
